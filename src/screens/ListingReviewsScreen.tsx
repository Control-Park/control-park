...
export default function ListingReviewsScreen({ route, navigation }: Props) {
      ...
      >
        <View style={[styles.pageMax, { paddingTop: insets.top + 10 }]}>
          ...
          <View style={styles.titleWrap}>
            <Text style={styles.title}>Listing Reviews</Text>
            {listingTitle ? (
            ...
            <View style={styles.emptyCard}>
              ...
              <Text style={styles.emptyText}>
                {isError
                  ...
                  : "This listing has not received any reviews yet."}
              </Text>
            </View>
          ) : null}
